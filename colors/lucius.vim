...
" Base color
" ----------
hi Normal           guifg=#e7ebe6           guibg=#333333
...
" -------------
" any comment
hi Comment          guifg=#c2b680                                   gui=none
...
" ----------
" int, long, char
hi Type             guifg=#dabfa5                                   gui=none
hi Type             ctermfg=115                                     cterm=none
" static, register, volative
hi StorageClass     guifg=#dabfa5                                   gui=none
hi StorageClass     ctermfg=115                                     cterm=none
" struct, union, enum
hi Structure        guifg=#dabfa5                                   gui=none
hi Structure        ctermfg=115                                     cterm=none
" typedef
hi Typedef          guifg=#dabfa5                                   gui=none
...
hi VertSplit        guifg=#777777           guibg=#262626           gui=none
...
hi WildMenu         guifg=#cae682           guibg=#262626           gui=bold,underline
...
"hi Folded           guifg=#91d6f8           guibg=#262626           gui=none
"hi Folded           ctermfg=117             ctermbg=238             cterm=none
hi Folded           guifg=#c2b680           guibg=#101010           gui=none
hi Folded           ctermfg=117             ctermbg=235             cterm=none
" column on side used to indicated open and closed folds
hi FoldColumn       guifg=#91d6f8           guibg=#262626           gui=none
hi FoldColumn       guifg=#c0c0d0           guibg=#262626           gui=none
...
hi StatusLine       guifg=#e0e0e0           guibg=#262626           gui=bold
hi StatusLine       ctermfg=254             ctermbg=237             cterm=bold
" status line for non-current windows
hi StatusLineNC     guifg=#767986           guibg=#262626           gui=none
...
hi TabLine          guifg=#9fafaf           guibg=#262626           gui=none
hi TabLine          ctermfg=244             ctermbg=236             cterm=none
" tab pages line, where there are no labels
hi TabLineFill      guifg=#9fafaf           guibg=#262626           gui=none
hi TabLineFill      ctermfg=187             ctermbg=236             cterm=none
" tab pages line, active tab page label
hi TabLineSel       guifg=#b7caca           guibg=bg               gui=bold
