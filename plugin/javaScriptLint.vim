...
if !exists('g:jslint_toggle')
    let g:jslint_toggle = 'false'
endif
...
func! ToogleJavaScriptLint()
    if g:jslint_toggle == 'true'
        let g:jslint_toggle = 'false'
    else
        let g:jslint_toggle = 'true'
    endif
endfunc

au FileType javascript nnoremap <silent> <F3> :call ToogleJavaScriptLint()<cr>
