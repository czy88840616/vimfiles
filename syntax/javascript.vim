...
" Last Change:  April 7, 2010
" Version:      0.7.8
" Changes:      Add "BUG #12334" as a issue id 
"               Add JSDOC-TOOLKIT TAGS
"               Remove Fold Feature, Conflict with my marker fdm
"
" TODO:
...
"" @Frank [20100407] 加入BUGID识别
syntax match   javaScriptCommentTodo    contained "\%(BUG\s*#[0-9]*\)"
...
if !exists("javascript_ignore_javaScriptdoc")
    ...
    "TODO 加入jsdoc-toolkit的METATAG支持

    syntax region javaScriptDocComment    matchgroup=javaScriptComment start="/\*\*\s*$"  end="\*/" contains=javaScriptDocTags,javaScriptCommentTodo,javaScriptCvsTag,@javaScriptHtml,@Spell fold
    syntax match  javaScriptDocTags       contained "@\(param\|argument\|requires\|exception\|throws\|type\|class\|extends\|returns\=\|augments\|see\|link\|member\|module\|method\|title\|namespace\|optional\|default\|base\|file\)\>" nextgroup=javaScriptDocParamType,javaScriptDocSeeTag skipwhite
    syntax match  javaScriptDocTags       contained "@\(beta\|deprecated\|description\|fileoverview\|author\|license\|version\|constructor\|private\|protected\|final\|ignore\|addon\|exec\)\>"
        " @Frank [20100407] 引入jsdoc-toolkit专属TAG
        syntax match  javaScriptDocTags       contained "@\(public\|borrows\|lends\|constructs\|constant\|event\|exports\|field\|ignore\|function\|inner\|memberOf\|property\|static\|example\|fileOverview\|since\|link\)"
            syntax match  javaScriptDocParamType  contained "\%(#\|\w\|\.\|:\|\/\)\+"
            "TODO 加入类似@param {type} value的三元识别
            "syntax match  javaScriptDocParamValue contained "\%(#\|\w\|\.\|:\|\/\)\+"
        ...
        if version >= 508 || !exists("did_javascript_syn_inits")
            ...
            HiLink javaScriptDocSpecial           Special
            HiLink javaScriptDocSeeTag            Function
            HiLink javaScriptDocParamType         Function
            HiLink javaScriptDocParamValue        String
