...
" @frank[2010/03/11]: \S* also match :hover{, which is wrong.
" syn match cssPseudoClass ":\S*" contains=cssPseudoClassId,cssUnicodeEscape
" FIXME: This allows selector start with :hover, which is wrong.
syn match cssPseudoClass ":[-a-zA-Z]*" contains=cssPseudoClassId,cssUnicodeEscape
